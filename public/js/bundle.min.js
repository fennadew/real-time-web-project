        ...
        var content = {
            showNotifications: function showNotifications(notifications) {
                ...
                var _loop2 = function _loop2(i) {
                    ...
                    var timeText = document.createTextNode("First notification on: " + _this3.timeConverter(notifications[i].Notificaties[0].time));
                    ...
                    for (var _a = 0; _a < notifications[i].Notificaties.length; _a++) {
                        var name = document.createElement('div');
                        var timeNot = document.createElement('div');
                        var timeTextNot = document.createTextNode("Posted on: " + _this3.timeConverter(notifications[i].Notificaties[_a].time));
                        var nameNot = document.createTextNode(notifications[i].Notificaties[_a].message);
                        var divNotContainer = document.createElement('div');
            ...
            updateNotications: function updateNotications(obj) {
                ...
                var noti = updateList.getElementsByClassName('noti');
                var child = noti[0].firstChild;
                ...
                for (var a = 0; a < obj.train.Notificaties.length; a++) {
                    console.log(obj.train.Notificaties);
                    var name = document.createElement('div');
                    var timeNot = document.createElement('div');
                    var timeTextNot = document.createTextNode("Posted on: " + this.timeConverter(obj.train.Notificaties[a].time));
                    var nameNot = document.createTextNode(obj.train.Notificaties[a].message);
                    var divNotContainer = document.createElement('div');
                    timeNot.appendChild(timeTextNot);
                    name.appendChild(nameNot);
                    divNotContainer.appendChild(name);
            ...
            addNotifications: function addNotifications(notification) {
                ...
                var divNot = document.createElement('div');
                divNot.classList.add('noti');
                for (var _a2 = 0; _a2 < notification.Notificaties.length; _a2++) {
                    var name = document.createElement('div');
                    var timeNot = document.createElement('div');
                    var timeTextNot = document.createTextNode("Posted on: " + this.timeConverter(notification.Notificaties[_a2].time));
                    var nameNot = document.createTextNode(notification.Notificaties[_a2].message);
                    var divNotContainer = document.createElement('div');
                    timeNot.appendChild(timeTextNot);
                    name.appendChild(nameNot);
                    divNotContainer.appendChild(name);
